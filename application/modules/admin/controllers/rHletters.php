 ...
 */
class rHletters extends Admin_Controller {
	...
	public function index(){
		...
		$crud = $this->generate_crud('hletters');
		//$crud->columns('letter_name','ref_no','sub_cat','file_url','created_at','letter_type','Status');
		$crud->add_fields('title','ref_no','record_index','file','created_at','record_type','Status');
